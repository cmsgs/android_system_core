...
static struct perms_ devperms[] = {
    ...
    /* SGS devices */
    { "/dev/pvrsrvkm",   0666,   AID_SYSTEM,     AID_SYSTEM,     0 },
    { "/dev/storage",   0755,   AID_RADIO,     AID_RADIO,     0 },
    { "/dev/fmradio",   0755,   AID_RADIO,     AID_RADIO,     0 },
    { "/dev/tspdrv",   0666,   AID_ROOT,     AID_ROOT,     0 },
    { "/dev/s3c_bc",   0666,   AID_SYSTEM,     AID_SYSTEM,     0 },
    { "/dev/cpuctl/bg_non_interactive/tasks",   0666,   AID_SYSTEM,     AID_SYSTEM,     0 },
    { "/dev/video0",   0664,   AID_SYSTEM,     AID_CAMERA,     0 },
    { "/dev/video1",   0664,   AID_SYSTEM,     AID_CAMERA,     0 },
    { "/dev/video2",   0664,   AID_SYSTEM,     AID_CAMERA,     0 },
    { "/dev/video20",   0664,   AID_SYSTEM,     AID_CAMERA,     0 },
    { "/dev/video21",   0664,   AID_SYSTEM,     AID_CAMERA,     0 },
    { "/dev/video22",   0664,   AID_SYSTEM,     AID_CAMERA,     0 },
    { "/dev/console",   0600,   AID_ROOT,     AID_ROOT,     0 },
    { "/dev/s3c-mem",   0666,   AID_SYSTEM,     AID_SYSTEM,     0 },
    { "/dev/s3c-g2d",   0664,   AID_SYSTEM,     AID_SYSTEM,     0 },
    { "/dev/s3c-g3d",   0664,   AID_SYSTEM,     AID_SYSTEM,     0 },
    { "/dev/s3c-mfc",   0664,   AID_SYSTEM,     AID_GRAPHICS,     0 },
    { "/dev/s3c-jpg",   0664,   AID_SYSTEM,     AID_GRAPHICS,     0 },
    { "/dev/mem",   0666,   AID_SYSTEM,     AID_SYSTEM,     0 },
    { "/dev/usb_mtp_gadget",   0777,   AID_ROOT,     AID_ROOT,     0 },
    { "/dev/snd/audio",   0660,   AID_SYSTEM,     AID_AUDIO,     0 },
    { "/dev/snd/pcmC0D0c",   0660,   AID_SYSTEM,     AID_AUDIO,     0 },
    { "/dev/snd/pcmC0D0p",   0660,   AID_SYSTEM,     AID_AUDIO,     0 },
    { "/dev/snd/seq",   0660,   AID_SYSTEM,     AID_AUDIO,     0 },
    { "/dev/snd/timer",   0660,   AID_SYSTEM,     AID_AUDIO,     0 },
    { "/dev/s3c2410_serial0",   0660,   AID_BLUETOOTH,     AID_BLUETOOTH,     0 },
    { "/dev/s3c2410_serial1",   0660,   AID_ROOT,     AID_SYSTEM,     0 },
    { "/dev/s3c2410_serial2",   0600,   AID_ROOT,     AID_ROOT,     0 },
    { "/dev/s3c2410_serial3",   0666,   AID_RADIO,     AID_RADIO,     0 },
    { "/dev/onedram",   0666,   AID_RADIO,     AID_ROOT,     0 },
    { "/dev/log/main",   0662,   AID_ROOT,     AID_LOG,     0 },
    { "/dev/log/radio",   0662,   AID_ROOT,     AID_LOG,     0 },
    { "/dev/log/events",   0662,   AID_ROOT,     AID_LOG,     0 },
    { "/dev/log/system",   0662,   AID_ROOT,     AID_LOG,     0 },
    { "/dev/block/",    0755,   AID_ROOT,     AID_ROOT,        1 },
    { "/dev/block/loop0",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/loop1",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/loop2",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/loop3",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/loop4",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/loop5",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/loop6",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/loop7",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl3",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl4",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl5",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl6",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl7",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl8",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl9",    0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl10",   0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl11",   0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/stl12",   0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/bml12",   0666,   AID_RADIO,     AID_ROOT,        0 },
    { "/dev/block/mmcblk0", 0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/mmcblk0p1", 0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/block/mmcblk0p2", 0600,   AID_ROOT,     AID_ROOT,        0 },
    { "/dev/graphics/fb0",    0664,   AID_ROOT,     AID_GRAPHICS,        0 },
    { "/dev/graphics/fb1",    0664,   AID_ROOT,     AID_GRAPHICS,        0 },
    { "/dev/graphics/fb2",    0664,   AID_ROOT,     AID_GRAPHICS,        0 },
    { "/dev/graphics/fb3",    0664,   AID_ROOT,     AID_GRAPHICS,        0 },
    { "/dev/graphics/fb4",    0664,   AID_ROOT,     AID_GRAPHICS,        0 },
